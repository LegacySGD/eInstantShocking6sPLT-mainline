...
public class Shocking6sPLTEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Shocking6sPLTEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Shocking6sPLTIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Shocking6sPLTIW/InitOutcome.xml").getDocumentElement();
